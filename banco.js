...
// function deposit(value, owner, c) {
//   c(checkClient(owner, list))
//   let saldo = 0
// }

// function bankOperation(pam1, db, operation) {
//   operation(checkClient(pam1, db))
//   console.log(returnedObject)
// }

// bankOperation('Ansel Ardley', list, checkClient)
